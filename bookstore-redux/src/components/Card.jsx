...
import { setIsEditing } from '../redux/books/isEditing/isEditing'
      ...
      <div className='flex-1 h-full pr-2 pt-2 flex flex-col'>
        <div className='flex items-center justify-between'>
          ...
          <div className='text-gray-500 space-x-2'>
            <button
              onClick={() => dispatch(setIsEditing(book))}
              className='lws-edit'
            >
              <svg
                fill='none'
        ...
        <div className='space-y-2 mt-4 h-full'>
          ...
          <div className='lws-stars'>
            {Array.from({ length: rating }, (value, i) => value).map(
              (point) => {
                return (
                  <svg
                    key={point + crypto.randomUUID()}
                    viewBox='0 0 20 20'
                    fill='currentColor'
                    className='lws-star'
                  >
